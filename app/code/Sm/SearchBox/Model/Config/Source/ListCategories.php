...
class ListCategories
{
	...
	public function toOptionArray($root_id, $depth)
	{
        ...
        $minimumToAvoid = $_modelCategory->load(611);
        $minimumToAvoid = $minimumToAvoid->getAllChildren(true);
        $child_catids = array_diff($child_catids, $minimumToAvoid);
        $child_catids = array_diff($child_catids, array(623));
