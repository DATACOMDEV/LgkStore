...
WHERE attribute_id=%d AND store_id=%d', $idAttributo, $idStoreFrancese));
if (!$results) {
...
foreach ($textData as $entityId => $value) {
    ...
    curl_setopt($ch, CURLOPT_POSTFIELDS, "text=".rawurlencode($value)."&target_lang=FR&source_lang=IT&tag_handling=html");
