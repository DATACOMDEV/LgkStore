...
$results = $conn->query(sprintf('SELECT entity_id FROM catalog_category_entity_varchar
...
foreach ($textData as $entityId => $value) {
    ...
    foreach ($deeplData['translations'] as $index => $data) {
        ...
        $oldValue = $conn->query(sprintf('SELECT value FROM catalog_category_entity_varchar
