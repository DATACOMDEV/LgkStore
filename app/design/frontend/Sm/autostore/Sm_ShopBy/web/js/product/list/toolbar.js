...
define([
    ...
    $.widget('mage.productListToolbarForm', $.mage.productListToolbarForm, {
        options: {
            ...
            filterItemControl: '.block.filter dd:not([data-request-var="cat"]) .item a, .block.filter .filter-clear,.block.filter .swatch-option-link-layered',
            url: ''
        },
        ...
        changeUrlOriginal: function (paramName, paramValue, defaultValue) {
            ...
            location.href = baseUrl + ((paramData.length > 2) ? '?' + paramData : '');
        },
        ...
        changeUrl: function (paramName, paramValue, defaultValue) {
            this.changeUrlOriginal(paramName, paramValue, defaultValue);
